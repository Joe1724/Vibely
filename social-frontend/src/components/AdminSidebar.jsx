...
const AdminSidebar = () => {
  const navItems = [
    ...
    { name: 'Content Moderation', path: '/admin/content', icon: (
    ...
    { name: 'Messaging', path: '/admin/messaging', icon: (
    ...
    { name: 'Ads & Announcements', path: '/admin/ads', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a2 2 0 100-4 2 2 0 000 4zM8.28 7.337l1.943-5.487 1.81 5.507M18 13a2 2 0 100-4 2 2 0 000 4z"></path></svg>
    )},
  ...
  return (
    <aside className="w-64 p-4 bg-white shadow-md dark:bg-gray-800">
      <h2 className="mb-6 text-xl font-semibold text-gray-800 dark:text-white">Admin Panel</h2>
      <nav>
